...
/* Chamadas de função */
func_call : TK_IDENTIFICADOR '(' lst_args ')' { char str[6] = "call "; strcat(str, $1.token); $$ = asd_new(str); asd_add_child($$, get_root($3)); printf("func_call\n"); }
          | TK_IDENTIFICADOR '(' ')' { char str[6] = "call "; strcat(str, $1.token); $$ = asd_new(str); printf("func_call\n"); };
lst_args : lst_args ';' expression { $$ = $3; asd_add_father($3, $1); printf("lst_args\n"); }
