...
/* Chamadas de função */
func_call : TK_IDENTIFICADOR '(' lst_args ')' { char str[6] = "call "; strcat(str, $1.token); $$ = asd_new(str); asd_add_child($$, $3); }
          | TK_IDENTIFICADOR '(' ')' { char str[6] = "call "; strcat(str, $1.token); $$ = asd_new(str); };
lst_args : lst_args ';' expression { $$ = $1; asd_add_child($$, $3); }
         | expression { $$ = $1; };
